...
binfunnel_t* create_funnel_tree(elem_t* array, int n, int bufsize) {
  ...
  //set_head(parent, array + TH);
    ...
    binfunnel_t* lcf = create_funnel_tree(array,           n / 2, BUFSIZE);
    binfunnel_t* rcf = create_funnel_tree(array + (n / 2), n / 2, BUFSIZE);
...
int main() {
  ...
  //while(nsize < 65536) {
    ...
    binfunnel_t* lcf = create_funnel_tree(test_array,           nsize / 2, BUFSIZE);
    binfunnel_t* rcf = create_funnel_tree(test_array + (nsize / 2), nsize / 2, BUFSIZE);
